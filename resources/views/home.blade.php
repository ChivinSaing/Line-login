        ...
        <nav class="sidebar-nav">
            <ul>
                    ...
                    <a href="#">
                        <span class="icon">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                ...
                                3 10C17.7737 10 18.3432 9.43708 18.2408 8.75433C17.7005 5.14918 14.8508 2.29947 11.2457
                                1.75912C10.5629 1.6568 10 2.2263 10 2.91665V9.16666C10 9.62691 10.3731 10 10.8333
                                10H17.0833Z" />
                            </svg>
                        </span>
                ...
                {{-- <li class="nav-item nav-item-has-children">
                    <a href="#0" class="" data-bs-toggle="collapse" data-bs-target="#ddmenu_2"
                    ...
                    <div class="col-md-6 order-last order-md-first">
                        <div class="copyright text-center text-md-start">
                            <p class="text-sm">
                                ...
                                <a href="https://web.facebook.com/profile.php?id=100093819876174" rel="nofollow"
                                    target="_blank">
                                    E-Coding
                                </a>
                            </p>
