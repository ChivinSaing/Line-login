    ...
    <form action="#" method="POST" class="max-w-2xl mx-auto p-6 bg-white shadow-xl rounded-2xl space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                <input type="email" name="email" id="email" class="mt-1 block w-full border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 outline-none">
            </div>
            ...
            <div>
                <label for="salon_website_1" class="block text-sm font-medium text-gray-700">Salon Website 1</label>
                <input type="url" name="salon_website_1" id="salon_website_1" class="mt-1 block w-full border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 outline-none">
            </div>

            <div>
                <label for="salon_website_2" class="block text-sm font-medium text-gray-700">Salon Website 2</label>
                <input type="url" name="salon_website_2" id="salon_website_2" class="mt-1 block w-full border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 outline-none">
            </div>
        </div>
